# -*- coding: utf-8 -*-
"""plant-disease-classification-train.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1G_0gd1a90mVvvd1qO0czI6HZCS0Umeeh
...
import os
os.listdir('/content/drive/MyDrive/Colab Notebooks/resize/')

path = "/content/drive/MyDrive/Colab Notebooks/resize.zip"
print("File exists:", os.path.exists(path))

!unzip "/content/drive/MyDrive/Colab Notebooks/resize.zip" -d "/content/drive/MyDrive/Colab Notebooks/resize"
...
data_dir = "/content/drive/MyDrive/Colab Notebooks/resize"
...
#To resize the images to 256x256 pixels
import os
from PIL import Image

# Define source and destination folder (use same folder if overwriting)
source_dir = "/content/drive/MyDrive/Colab Notebooks/input/valid"  # Change this to your main folder
output_dir = "/content/drive/MyDrive/Colab Notebooks/input/resize/valid"  # Change or keep same as source_dir

# Desired size (change as needed)
target_size = (256, 256)
...
def resize_images(source_folder, output_folder, size):
    for root, _, files in os.walk(source_folder):  # Walk through all folders
        for file in files:
            if file.lower().endswith(("png", "jpg", "jpeg")):  # Check for image formats
                img_path = os.path.join(root, file)
                save_path = img_path.replace(source_folder, output_folder)
                ...
                try:
                    with Image.open(img_path) as img:
                        img_resized = img.resize(size, Image.LANCZOS)  # Resize with anti-aliasing
                        img_resized.save(save_path)  # Save resized image
                        print(f"Resized and saved: {save_path}")
                except Exception as e:
                    print(f"Error processing {img_path}: {e}")

# Run the function
resize_images(source_dir, output_dir, target_size)
...
# Define source and destination folder (use same folder if overwriting)
source_dir = "/content/drive/MyDrive/Colab Notebooks/input/train"  # Change this to your main folder
output_dir = "/content/drive/MyDrive/Colab Notebooks/input/resize/train"  # Change or keep same as source_dir
...
#To zip the specific folder
#import shutil

# Define the folder to zip and the output zip file
#folder_to_zip = "/content/drive/MyDrive/Colab Notebooks/input/resize"  # Change this to your folder path
#output_zip = "resize.zip"  # Name of the output zip file

# Create a zip file
#shutil.make_archive(output_zip.replace(".zip", ""), 'zip', folder_to_zip)

#print(f"Folder '{folder_to_zip}' zipped successfully as '{output_zip}'")
...
path = "/content/drive/MyDrive/Colab Notebooks/resize/test.zip"
print("File exists:", os.path.exists(path))

!unzip "/content/drive/MyDrive/Colab Notebooks/resize/test.zip" -d "/content/drive/MyDrive/Colab Notebooks/resize/test"

test_dir = "/content/drive/MyDrive/Colab Notebooks/resize/test"
...
for img, label in test:
    predicted_label = predict_image(img, model)  # Predict the label
