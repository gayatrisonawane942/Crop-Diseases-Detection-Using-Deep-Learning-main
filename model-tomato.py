...
train_generator = train_datagen.flow_from_directory(
        'D:/PROJECTS/PYTHON PROJECTS/Multi_Crop/Main_Dataset/train/Tomato',  # This is the source directory for training images
...
model = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Dense(10, activation='softmax') #Number of Diseases
])
